...
#endif
#if defined(CM47_MIPI_RAW)
	{CM47_SENSOR_ID,SENSOR_DRVNAME_CM47_MIPI_RAW,CM47_MIPI_RAW_SensorInit},
#endif
#if defined(CM60_MIPI_RAW)
	{CM60_SENSOR_ID,SENSOR_DRVNAME_CM60_MIPI_RAW,CM60_MIPI_RAW_SensorInit},
#endif
